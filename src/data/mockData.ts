...
export const initialNotifications: AppNotification[] = [
  {
    ...
    type: 'policy-expiry',
    title: '保單即將到期',
    message: '王建國的「富邦人壽日額醫療附約」將於 2026/08/01 到期',
    date: '2026-03-08',
    read: false,
    memberId: 'm1',
  },
  ...
  },
  {
    ...
    title: '保單申購進度',
    message: '王建國的「新光人壽長照尊榮加保」申請審核中，預計 7 個工作天',
    date: '2026-03-05',
    read: true,
    memberId: 'm1',
  },
  ...
  },
  {
    ...
    type: 'policy-expiry',
    title: '保單即將到期',
    message: '王小美的「全球人壽醫護人員意外險」將於 2027/12/01 到期',
    date: '2026-03-10',
    read: true,
    memberId: 'm6',
  },
...
export const initialFamilyEvents: FamilyEvent[] = [
  {
    ...
    fundsNeeded: 50000,
    urgency: 'high',
    description: '王阿公已有富邦長照月給 2 萬，評估是否需加強居家照護與月給付',
    memberIds: ['m4'],
    createdBy: '王建國',
  },
  {
